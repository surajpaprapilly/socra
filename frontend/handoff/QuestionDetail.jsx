...
export default function QuestionDetail({
  ...
  return (
    <div className="flex-1 overflow-y-auto px-12 py-10 animate-in slide-in-from-left-2 duration-300 relative z-10">
      ...
      <div className="mb-9">
        ...
        <h2 className="font-display text-2xl text-textDefault font-normal leading-relaxed border-l-[3px] border-amber pl-5 max-w-3xl">
          "{item.q}"
        </h2>
      </div>
